...
{
    public async Task<IActionResult> Index(string? bookNumber = null, string? query = null, CancellationToken cancellationToken = default)
    {
        ...
        viewModel.Results = results.Where(b => b.BookNumber.Contains(s, StringComparison.OrdinalIgnoreCase)
                                        ...
                                        || b.AuthorOrEditor.Contains(s, StringComparison.OrdinalIgnoreCase)).Take(15).ToList();
